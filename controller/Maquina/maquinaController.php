    ...
    public function getTable(){
        ...
        if (mysqli_num_rows($maquinas) > 0) {
            ...
            while($row = mysqli_fetch_assoc($maquinas)) {
                $btnAcciones = "<div class='form-button-action'><button type='button' title='' class='editar btn btn-link btn-primary btn-lg' data-original-title='Editar'  data-toggle='modal' data-target='#editarMaquinaModal' ><i class='fa fa-edit'></i></button>";
                if($row['est_codigo']==1){
